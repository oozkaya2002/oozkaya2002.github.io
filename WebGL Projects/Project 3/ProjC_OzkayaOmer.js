...
var lightingMode = true;

var lightModeString = 'Blinn-Phong Lighting';
var shadeModeString = 'Gouraud Shading';

function main() {
//=============================================================================
  
  console.log("The first sphere of the orbiting spheres is made of 'shiny copper'.");
  console.log("The second sphere of the orbiting spheres is made of 'rubber'.");
  console.log("The third sphere of the orbiting sphere is made of 'chrome'.");
  console.log("The snake-like object to the far right back of the scene is made of 'turquoise'.");
  console.log("The star below the sphere is made of 'blue plastic'.");
  console.log("The sphere on top of the star is made of 'pearl'.");
...
// setCamera();				// TEMPORARY: set a global camera used by ALL VBObox objects...
  ...
  //    https://webglfundamjentals.org/webgl/lessons/webgl-animation.html
  //  or
...
//=============================================================================
  ...
  var width_of_window = innerWidth;
	var height_of_window = innerWidth*0.5;
	var FOV = 35.0;
	...
	g_worldMat.perspective(	FOV,   // FOVY: top-to-bottom vertical image angle, in degrees
  ...
  g_worldMat.lookAt(  camX, camY, camZ,	// center of projection
...
// Called when user presses HTML-5 button 'Show/Hide VBO1'.
  ...
  { 
    g_show1 = 1;	// show,
    g_show2 = 0;
    shadeModeString = 'Gouraud Shading'
  }			
  else 
  {
    g_show1 = 0; // hide.
    g_show2 = 1;
    shadeModeString = 'Phong Shading'
  }
  // console.log('g_show0: '+g_show0);
}
...
//---------------------Camera Position---------------------
    ...
    case "KeyG":
      if(lightingMode){
        lightingMode = false;
        lightModeString = 'Phong Lighting';
      }
      else{
        lightingMode = true;
        lightModeString = 'Blinn-Phong Lighting';
      }
      document.getElementById("lightModeString").innerHTML = "Light Mode: " + lightModeString;
      break;
    
    case "KeyH":
      VBO1toggle();
      document.getElementById("shadeModeString").innerHTML = "Shader Mode: " + shadeModeString;  
	}
}
